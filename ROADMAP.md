...
- [x] `npm run test:unit` passes (49 files / 972 tests on Feb 12, 2026).
...
- Pass 1: `npm run test:unit` (49 files / 972 tests), `npm run test:harness` (5 files / 53 tests), `npm run test:sim` (2 files / 5 tests) all green.
