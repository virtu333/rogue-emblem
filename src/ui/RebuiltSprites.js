import {
  ...
  battlefieldTracedSpritesEnabled,
...
// The previous battlefield sprite set, kept as the dev comparison (?spriteArt=rebuilt).
// The traced sprites (TracedSprites.js) replaced it as the default: while they are on,
// none of these files is downloaded. They ship pre-baked at their 64/128 px size either
// way (docs/mobile-memory-budget.md).
export function rebuiltSpritesEnabled(search) {
  return battlefieldSpriteArtEnabled(search) && !battlefieldTracedSpritesEnabled(search);
}
