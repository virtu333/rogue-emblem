...
export const HERO_SUBJECTS = {
  ...
  'tempest-blade': `a short silver throwing sword with a sky-blue gem in the guard and pale wind curling around it, ${DIAG}`,
  ...
  tomahawk: `a silver tomahawk throwing axe with two feathers tied under the head, ${DIAG}`,
  ...
  sunflare: `${BOOK}: a white prayer book with a crimson star emblem and hot light`,
  ...
  'silence-staff': `${STAFF}: a black staff with a closed crescent head and a dark violet gem`,
  ...
  remedy: 'a small round tin of salve with a red cross on the lid',
  // Accessories
  ...
  'shield-ring': 'a gold ring set with a round steel-blue gem',
  'barrier-ring': 'a gold ring set with a round lilac gem',
  'skill-ring': 'a gold ring set with a round pearl-white gem',
  ...
  'counter-seal': 'a silver medal with a steel cross emblem, hanging from a grey ribbon',
