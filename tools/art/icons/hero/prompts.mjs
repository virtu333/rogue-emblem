...
export const HERO_SUBJECTS = {
  ...
  'killing-edge': `a katana-like sword made for killing strokes: a long, gently curved, single-edged mirror-silver blade with a wavy crimson temper line along the cutting edge, a small round black-iron disc guard, a long two-handed grip wrapped in black cord over crimson diamonds, a short blood-red tassel at the pommel, ${DIAG}`,
  ...
  'tempest-blade': `a short silver throwing sword whose blade sweeps in a curve like a gust of wind frozen in steel, pale sky-blue wind streaks spiralling around the blade, a sky-blue gem in a swept guard, a pale blue ribbon streaming from the pommel as if in a gale, ${DIAG}`,
  ...
  'levin-sword': `a silver magic sword whose blade is forged in the zig-zag shape of a lightning bolt, jagged stepped edges ending in a sharp point, crackling sky-blue electric arcs leaping from it, a storm-grey crossguard with a glowing sky-blue gem, ${DIAG}`,
  gemini: `a legendary sword with two slender parallel blades rising from one gilded hilt, ${DIAG}`,
  armorslayer: `a deadly curved steel blade like a slim falchion, its back thick and ridged for strength, the curved edge razor-honed and narrowing to a hardened needle point made to slip between armour plates, a small steel crossguard, a grip wrapped in dark leather, a green gem pommel, ${DIAG}`,
  ...
  axereaver: `an unorthodox nimble steel axe made for fighting swordsmen: a light slender haft, a small crescent blade with a long curved hook-beard sweeping down to catch and wrench away sword blades, a short parrying spike on the back, a steel-blue finish, ${DIAG}`,
