...
export const BIOMES = {
  grassland: {
    ...
    rock: { ramp: [1, 2, 3, 4, 5, 6, 7].map((k) => R('rock', k)), outline: R('rock', 0), cap: null },
    flowers: [R('ink', 10), R('ember', 5), R('blood', 5)],
    tufts: true,
  },
  tundra: {
    defaultGround: G.GRASS,
    ground: { dark: R('snow', 2), base: R('snow', 3), light: R('snow', 4), hi: R('snow', 5), blade: R('earth', 4), shade: R('snow', 1), stretch: [0.35, 1.7] },
    ...
    rock: {
      ramp: [R('ink', 4), R('ink', 5), R('stone', 3), R('stone', 4), R('ink', 8), R('ink', 9), R('ink', 10)],
      outline: R('ink', 3),
      cap: { ramp: [R('snow', 1), R('snow', 2), R('snow', 3), R('snow', 4), R('snow', 5), R('snow', 6)] },
    },
    flowers: null,
    tufts: 'dry',
  },
  volcano: {
    defaultGround: G.GRASS,
    ground: { dark: R('ash', 3), base: R('ash', 4), light: R('ash', 5), hi: R('ash', 6), blade: R('earth', 3), shade: R('ash', 2), stretch: [0.6, 1.2] },
    ...
    rock: { ramp: [R('ink', 2), R('ash', 1), R('ash', 2), R('ash', 3), R('ash', 4), R('ash', 5), R('ash', 6)], outline: R('ink', 1), cap: null, ember: true },
    flowers: null,
    tufts: 'dry',
  },
  swamp: {
    ...
    rock: { ramp: [R('rock', 1), R('rock', 2), R('rock', 3), R('earth', 3), R('earth', 4), R('earth', 5), R('soil', 7)], outline: R('rock', 0), cap: null },
    flowers: [R('ink', 10)],
    tufts: true,
  },
  castle: {
    ...
    tree: 'broadleaf',
    leaf: [f(0), f(1), f(2), f(3), f(4), f(5), f(6), f(7), f(8)],
    rock: { ramp: [R('ink', 4), R('ink', 5), R('stone', 3), R('stone', 4), R('stone', 5), R('ink', 9), R('ink', 10)], outline: R('ink', 2), cap: null },
    flowers: null,
    tufts: false,
  },
  void: {
    ...
    rock: { ramp: [R('ink', 2), R('ink', 3), R('ink', 4), R('ink', 5), R('unlight', 2), R('ink', 7), R('ink', 8)], outline: R('ink', 0), cap: null },
    flowers: null,
    tufts: false,
  },
};
...
export const MASONRY = {
  default: {
    ...
    floorMortar: { [R('rock', 5)]: R('rock', 4), [R('rock', 4)]: R('rock', 3), [R('rock', 6)]: R('rock', 5) },
  ...
  void: {
    ...
    floorMortar: { [R('ink', 5)]: R('ink', 4), [R('ink', 4)]: R('ink', 3), [R('unlight', 2)]: R('unlight', 1) },
  ...
  tundra: {
    ...
    floorMortar: { [R('stone', 4)]: R('stone', 3), [R('snow', 2)]: R('snow', 1), [R('snow', 3)]: R('snow', 2) },
