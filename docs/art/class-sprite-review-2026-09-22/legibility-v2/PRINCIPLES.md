...
## User-directed refinement: size and blade grammar

- Thief: 80% of prior rendered width and height, same texture canvas, tile and feet.
  Crouch must remain small; do not normalize its head to a standing unit.
- Myrmidon: long narrow bright-white blade; hilt at waist prevents excessive
  overhang. Keep enough blade width to survive final rasterization.
- Mercenary: broad white steel plane over shoulder. Thief: short white blade.
- Blade length, thickness and direction should be judged together at actual map
  scale. White is a highlight mass bounded by gray/charcoal, not a glow effect.
- This pass supersedes the previous short-blade Myrmidon and oversized Thief.
  Older results above are historical observations, not current acceptance claims.

Preview placement: Myrmidon uses 112% of its standard full-bounds fit (about 38px total height) to retain body size while allowing blade overhang. Thief uses 80% (about 27px). These are experimental art-review placements only.
